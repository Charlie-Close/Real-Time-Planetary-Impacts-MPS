...
set_target_properties(hdf5-shared PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "libaec::sz"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5.310.5.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5-shared )
list(APPEND _cmake_import_check_files_for_hdf5-shared "${_IMPORT_PREFIX}/lib/libhdf5.310.5.0.dylib" )
...
set_target_properties(hdf5_tools-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_tools.310.0.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_tools.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_tools-shared )
list(APPEND _cmake_import_check_files_for_hdf5_tools-shared "${_IMPORT_PREFIX}/lib/libhdf5_tools.310.0.5.dylib" )
...
set_target_properties(hdf5_hl-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_hl.310.0.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_hl.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_hl-shared )
list(APPEND _cmake_import_check_files_for_hdf5_hl-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl.310.0.5.dylib" )
...
set_target_properties(hdf5_f90cstub-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_f90cstub.310.3.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_f90cstub.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_f90cstub-shared )
list(APPEND _cmake_import_check_files_for_hdf5_f90cstub-shared "${_IMPORT_PREFIX}/lib/libhdf5_f90cstub.310.3.1.dylib" )
...
set_target_properties(hdf5_fortran-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_fortran.310.3.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_fortran.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_fortran-shared )
list(APPEND _cmake_import_check_files_for_hdf5_fortran-shared "${_IMPORT_PREFIX}/lib/libhdf5_fortran.310.3.1.dylib" )
...
set_target_properties(hdf5_hl_f90cstub-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_hl_f90cstub.310.0.5.dylib"
...
list(APPEND _cmake_import_check_files_for_hdf5_hl_f90cstub-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_f90cstub.310.0.5.dylib" )
...
set_target_properties(hdf5_hl_fortran-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_hl_fortran.310.0.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_hl_fortran.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_hl_fortran-shared )
list(APPEND _cmake_import_check_files_for_hdf5_hl_fortran-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_fortran.310.0.5.dylib" )
...
set_target_properties(hdf5_cpp-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_cpp.310.0.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_cpp.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_cpp-shared )
list(APPEND _cmake_import_check_files_for_hdf5_cpp-shared "${_IMPORT_PREFIX}/lib/libhdf5_cpp.310.0.5.dylib" )
...
set_target_properties(hdf5_hl_cpp-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp.310.0.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libhdf5_hl_cpp.310.dylib"
  )

list(APPEND _cmake_import_check_targets hdf5_hl_cpp-shared )
list(APPEND _cmake_import_check_files_for_hdf5_hl_cpp-shared "${_IMPORT_PREFIX}/lib/libhdf5_hl_cpp.310.0.5.dylib" )
